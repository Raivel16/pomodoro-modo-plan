...
- Roadmap acordado: R1 esqueleto + temporizador 25/5 (hecho) → R2 refinamiento de controles → R3 notificaciones (Web Audio API sintetizada, sin archivos de audio) y visuales → R4 contador de pomodoros en memoria → R5 pulido responsive/accesibilidad.
