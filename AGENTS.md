...
- Roadmap acordado: R1 esqueleto + temporizador 25/5, R2 refinamiento de controles, R3 notificaciones y R4 contador de pomodoros (hechos) → R5 pulido responsive/accesibilidad.
