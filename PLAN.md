...
| R2 | Refinamiento de controles del temporizador | estados y UX de Iniciar/Pausar/Reiniciar | Pendiente |
| R3 | Notificaciones sonoras (Web Audio) y visuales al finalizar ciclo | `audio.js` + zona `#status-region` | Pendiente |
